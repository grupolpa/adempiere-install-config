...
JAVA_BINARY=OpenJDK17-jdk_x64_linux_hotspot_17_35.tar.gz
...
JAVA_HOME="/var/lib/jvm/java/jdk-17+35"
# export $JAVA_HOME
...
update-alternatives --install /usr/bin/java java $JAVA_HOME/bin/java 4
update-alternatives --install /usr/bin/javac javac $JAVA_HOME/bin/javac 4
# update-alternatives --install /usr/bin/javaws javaws $JAVA_HOME/bin/javaws 4
